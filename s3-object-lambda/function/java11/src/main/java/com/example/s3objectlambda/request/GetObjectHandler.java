...
import com.example.s3objectlambda.transform.AuthorizationException;
...
public class GetObjectHandler implements RequestHandler {
    ...
    public void handleRequest() {
        ...
        try {
            ...
            this.responseHandler.writeErrorResponse(e.getMessage(), Error.UNAUTHORIZED);
            return;
        }

        this.responseHandler.writeObjectResponse(presignedResponse, transformedObject);
    }
